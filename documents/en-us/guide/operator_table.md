...
- Newlines also function as operators, acting as evaluation boundaries at line scope. A newline followed by a line that starts with a space or one of the infix operators listed in section 0 is not a boundary but a continuation ([`preprocessor.md`](../impl/build/preprocessor.md) section 0).
