...
// 5 桁を越える数と負の数（以前は5桁目で止まり、dec 100000 が "00000"、dec (0 - 3) が "7" だった）。
for (const n of [0, 7, 42, 176, 1000, 4660, 65535, 99999, 100000, 1234567890, 100000000000000, 9223372036854775807n, -3, -100000]) {
